...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.checkBox.setGeometry(QtCore.QRect(90, 120, 79, 20))
        self.checkBox.setChecked(False)
        self.checkBox.setAutoExclusive(False)
        self.checkBox.setTristate(False)
        self.checkBox.setObjectName("checkBox")
        self.checkBox_2 = QtWidgets.QCheckBox(parent=Form)
        self.checkBox_2.setGeometry(QtCore.QRect(90, 160, 79, 20))
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkBox_3 = QtWidgets.QCheckBox(parent=Form)
        self.checkBox_3.setGeometry(QtCore.QRect(90, 200, 79, 20))
        self.checkBox_3.setObjectName("checkBox_3")
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(90, 80, 101, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "做出您的选择"))
