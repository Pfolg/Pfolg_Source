...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 40, 160, 241))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_2.setText(_translate("Form", "消息"))
        self.pushButton_3.setText(_translate("Form", "错误"))
        self.pushButton.setText(_translate("Form", "问答"))
        self.pushButton_5.setText(_translate("Form", "关于"))
        self.pushButton_4.setText(_translate("Form", "警告"))
