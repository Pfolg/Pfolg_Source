...
## 游戏内文本使用的字体。
define gui.text_font = "MapleMono-NF-CN-Medium.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "MapleMono-NF-CN-Bold.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "MapleMono-NF-CN-Medium.ttf"
...
define gui.main_menu_background = Transform("images/bg bg1.png", zoom=1.25, xalign=0.5, yalign=0.5)
define gui.game_menu_background = Transform("images/bg bg1.png", zoom=1.25, xalign=0.5, yalign=0.5)
